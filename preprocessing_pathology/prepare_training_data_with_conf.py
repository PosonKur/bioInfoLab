...
def majority_vote_pathology(entries, patch_center):
    ...
    # Patch and circle geometry (match clustering script)
    patch_size = 224
    ...
    # Normalize by this value; min() is a safeguard against rare floating-point or grid artifacts
    ...
    # Reduce confidence for tie-breaking cases
...
pathology_dict = {}
pathology_file = 'Pathology_annotations.csv'
